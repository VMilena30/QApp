...
TEXTOS_ML = {
    "pt": {
        ...
        "help_1": "Escolha uma base de dados pré-carregada com sinais de vibração ou a base de dados da CWRU.",
    ...
    "en": {
        ...
        "help_1": "Choose a pre-loaded database with vibration signals or the CWRU dataset.",
